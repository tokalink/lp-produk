<?php namespace App\Http\Controllers;
	...
	class AdminTemplateCopywritingsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "template_copywritings";
			...
			$this->form[] = ['label'=>'File','name'=>'file','type'=>'text','validation'=>'','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'','width'=>'col-sm-10','dataenum'=>'active;inactive'];
