<?php namespace App\Http\Controllers;
	...
	class AdminPembelianproduksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "pembelianproduks";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Produk","name"=>"id_produk","join"=>"produks,nama_produk"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Produk','name'=>'id_produk','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'produks,nama_produk'];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:pembelianproduks','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Produk","name"=>"id_produk","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"produk,id"];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:pembelianproduks","placeholder"=>"Please enter a valid email address"];
