<?php namespace App\Http\Controllers;
	...
	class AdminDevicesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Host","name"=>"host"];
			$this->col[] = ["label"=>"Apikey","name"=>"apikey"];
			...
			$this->form[] = ['label'=>'Host','name'=>'host','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Apikey','name'=>'apikey','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];			
			...
			//$this->form[] = ["label"=>"Host","name"=>"host","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Apikey","name"=>"apikey","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
