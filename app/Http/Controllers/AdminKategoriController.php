<?php namespace App\Http\Controllers;
	...
	class AdminKategoriController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Keywords","name"=>"keywords"];
			...
			$this->form[] = ['label'=>'Vendor','name'=>'vendor','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Keywords','name'=>'keywords','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
